...
**Steam-style plugin marketplace for DeepSeek Harness.** Browse **559+
...
- 📦 Registry: [registry.json](./registry.json) — 559 plugins, 20 verified by
...
| Tool | Purpose |
| --- | --- |
| `market_search` | Search 559+ plugins by query/category/verified flag, sorted by stars |
...
| --- | --- | --- |
| Registry size | 559+ (awesome-dsh-plugin mirror + verified curation) | 300+ (awesome-dsh-plugin live) |
...
**559+ 社区插件**、一键订阅，然后**一条命令**把全部订阅装进你的 dsh
